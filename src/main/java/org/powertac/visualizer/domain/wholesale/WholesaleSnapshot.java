...
public class WholesaleSnapshot
{
  ...
  public String toString ()
  {
    ...
    if (orders != null) {
      ...
      for (Iterator<VisualizerOrderbookOrder> iterator = asks.iterator(); iterator
              .hasNext();) {
        VisualizerOrderbookOrder orderbookOrder =
          (VisualizerOrderbookOrder) iterator.next();
        builder.append(orderbookOrder).append("\n");
      }
      builder.append("ORDERS:\nBIDS:");
      SortedSet<VisualizerOrderbookOrder> bids = orders.getBids();
      for (Iterator<VisualizerOrderbookOrder> iterator = bids.iterator(); iterator
              .hasNext();) {
        VisualizerOrderbookOrder orderbookOrder =
          (VisualizerOrderbookOrder) iterator.next();
        builder.append(orderbookOrder).append("\n");
                               ...
                               JSONArray seriesColorsAfterClearing)
  {
    ...
    for (Iterator<VisualizerOrderbookOrder> iterator = asksAfter.iterator(); iterator
            .hasNext();) {
      VisualizerOrderbookOrder orderbookOrder =
        (VisualizerOrderbookOrder) iterator.next();
    ...
    for (Iterator<VisualizerOrderbookOrder> iterator = bidsAfter.iterator(); iterator
            .hasNext();) {
      VisualizerOrderbookOrder orderbookOrder =
        (VisualizerOrderbookOrder) iterator.next();
      // if a market order in orderbook can be found:
