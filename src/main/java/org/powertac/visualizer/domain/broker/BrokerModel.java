  ...
  implements VisualBroker, DisplayableBroker, TimeslotModelUpdate
{
  ...
  public void addTariffTransaction (TariffTransaction tariffTransaction)
  {
    ...
    if (tariffTransaction.getCustomerInfo() != null) {
      for (Iterator<CustomerModel> iterator = customerModels.iterator(); iterator
              .hasNext();) {
    ...
    tariffInfoMaps.get(tariffTransaction.getTariffSpec().getId())
            .addTariffTransaction(tariffTransaction);
  ...
  public void buildCustomersBubble ()
  {
    ...
    for (Iterator<CustomerModel> iterator = customerModels.iterator(); iterator
      ...
      customerBubbleJson.put((int) customer.getTotalCash())
              .put((int) customer.getTotalEnergy())
              .put(customer.getCustomerCount())
              .put(customer.getCustomerInfo().getName());
